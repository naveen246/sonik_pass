window.onunload = function() {
    ...
    function r(t) {
        for (var e = "", i = 0, n = t.length; n > i; i++) e += '<li class="team-member"><div class="member-image-container"><img src="' + t[i].image + '" alt="' + t[i].name + '" class="member-image"></div><h3 class="subheadline">' + t[i].name + '</h3><div class="caption">' + t[i].title + '</div><p class="copy">' + t[i].bio + "</p></li>";
        $(".team").append(e)
    }

    function c() {
        var t, e = "../js/team.json",
            i = new XMLHttpRequest;
        i.open("GET", e, !0), i.onload = function(e) {
            4 === i.readyState && (200 === i.status ? (t = JSON.parse(i.responseText), r(t)) : console.error(i.statusText))
        }, i.onerror = function(t) {
            console.error(i.statusText)
        }, i.send(null)
    }
    ...
    var u, d = $("body"),
        ...
        g = $(".lower-type"),
        w = $(".upper-type"),
        f = (parseInt($(".lower-type").css("font-size")), ["Sonikpass", "Problem", "Solution", "Usecases", "Contact"]),
        x = (f.length, !1),
        b = 0,
        v = 500;
    ...
    var T = {
        ...
        solutionIllustration: function() {
            ...
            t.to(".s_phone", 2, {
                ...
                opacity: 1
            }, "-=1.4").to(".s_watch .circle-container", .5, {
                opacity: 1
            }, "-=1.2")
        },
        usecasesIn: function() {
